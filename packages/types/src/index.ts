...
/**
 * Ключ вида действия. На wire — непрозрачная строка в неймспейсе control
 * plane: сервер не валидирует её против закрытого списка, незнакомый ключ
 * просто не гейтится. Закрытые enum-ы своих ключей держат семейные слои
 * (`@haia/evm` и далее) — это деталь их механики, а не контракта.
 */
